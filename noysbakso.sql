...
INSERT INTO `pemesanan` (`pesanan_id`, `no_user`, `alamat`, `pengiriman`, `ongkir`, `payment`, `total_bayar`, `tanggal_pesanan`) VALUES
(37, 18, 'ds mojosari kec kras', 'Gojek', 12000, 'gopay', '57000', '2026-04-05 15:33:55'),
(38, 14, 'ds susuhbango', 'Grab', 14000, 'linkaja', '754000', '2026-04-05 15:33:55'),
(39, 20, 'beji', 'Grab', 14000, 'shopeepay', '48000', '2026-04-05 15:33:55');
...
INSERT INTO `produk` (`no_produk`, `nama_produk`, `harga`, `stok`) VALUES
(1, 'Bakso Biasa', 'Rp.7000', 140),
(2, 'Bakso Jumbo', 'Rp.12000', 135),
(3, 'Bakso Urat', 'Rp.7000', 234),
(4, 'Joshua', 'Rp.5000', 390),
(5, 'Es Degan', 'Rp.5000', 232);
...
(21, 'admin', 'admin@gmail.com', 'admin123');
...
--
ALTER TABLE `user_acc`
  MODIFY `no_user` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
